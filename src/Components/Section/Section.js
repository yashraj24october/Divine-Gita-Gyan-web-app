...
<Zoom>
<h2 style={{borderRadius:".8rem",padding:".5rem",border:"2px solid white",color:"yellow",position:"relative",bottom:"6rem",background:"rgba(25, 0, 255, 0.288)"}}>ॐ नमो भगवते वासुदेवाय नमः</h2>
</Zoom>
